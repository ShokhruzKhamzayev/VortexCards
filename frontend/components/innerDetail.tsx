            ...
            person.isPaid ? (
                <>
                    ...
                    <InfoInnerDetail Icon={<FaRegShareFromSquare size={30}/>}>
                        ...
                        <Link className='bg-transparent border border-slate-800 dark:border-slate-100  rounded-[12px] py-[8px] px-[15px] w-fit mx-auto block my-[20px]' href={`/${locale}#contact`}>{t("getCard")}</Link>
                        </div>
                    </InfoInnerDetail>
                    </div>
                </>
